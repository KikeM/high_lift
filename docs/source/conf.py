...
htmlhelp_basename = 'high-lift-doc'
...
latex_documents = [
    (master_doc, 'high-lift.tex', 'high-lift Documentation',
     'COM', 'manual'),
]
...
man_pages = [
    (master_doc, 'high-lift', 'high-lift Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'high-lift', 'high-lift Documentation',
     author, 'high-lift', 'One line description of project.',
     'Miscellaneous'),
]
